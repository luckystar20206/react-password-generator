  ...
  return (
    <div className='w-6/12 mx-auto mt-12 py-8 border border-1 border-slate-500 bg-violet-200 rounded-lg'>
      ...
      <div className='text-center'>
        <input type="text" placeholder='password' className='px-6 py-2 rounded-full mr-6 outline-none border-none select-none' value={password} readOnly ref={passwordReference}/>
        <i className="fa-solid fa-rotate mr-6 cursor-pointer" onClick={() => passwordGenerator()}></i>
        <button id="copy-button" className='copy-button bg-blue-600 text-white px-3 py-2 rounded-full w-24 font-bold select-none' onClick={() => copyPasswordToClipboard()}>Copy</button>
      </div>
